...
public class TestDemo {
    ...
    public static void main(String[] args) {
      //  System.out.println(Short.SIZE);//位大小
     //   System.out.println(Short.BYTES);//字节大小

      //  System.out.printf("%0",1234);
     //   System.out.printf("%o",1234);
        System.out.printf("%10s",Integer.parseInt("ABCDEF",16));
//        Integer a=1234;
//        System.out.println(change("1234",10,8));
//       // System.out.printf("%0",1234);
//     //   System.out.printf("%x",1234);
//        System.out.println(' ');
//       // System.out.printf("%oX",1234);
//     //   System.out.printf("%0X",1234);
//        System.out.println(' ');
